    ...
    <header className="fixed top-0 left-0 right-0 z-50 glass-header">
      <div className="max-w-7xl mx-auto flex items-center justify-between px-6" style={{height: 'var(--site-header-height)'}}>
        ...
        <nav className="hidden md:flex gap-6 text-base items-center">
          ...
          <Link href="/features" className="menu-item font-orbitron">Features</Link>
          <Link href="/pricing" className="menu-item ml-4 px-4 py-2 rounded-lg bg-gradient-to-r from-[#0b3b8a] via-[#0bb38a] to-[#f5d300] text-black font-bold shadow">Get Started</Link>
        </nav>
